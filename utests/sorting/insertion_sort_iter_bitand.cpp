...
namespace sorting
{
    ...
    struct populated_two_inorder_elem_test_insertion_sort_iter_bitand_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_two_revorder_elem_test_insertion_sort_iter_bitand_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_single_elem_test_insertion_sort_iter_bitand_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
