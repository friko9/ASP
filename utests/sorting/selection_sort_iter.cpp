...
namespace sorting
{
    ...
    struct populated_multiple_same_elem_test_selection_sort_iter_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    ENABLE_TEST(access_test_set(),populated_multiple_same_elem_test_selection_sort_iter_state_sorted);

    struct populated_two_inorder_elem_test_selection_sort_iter_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    ENABLE_TEST(access_test_set(),populated_two_inorder_elem_test_selection_sort_iter_state_sorted);

    struct populated_two_revorder_elem_test_selection_sort_iter_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    ENABLE_TEST(access_test_set(),populated_two_revorder_elem_test_selection_sort_iter_state_sorted);

    struct populated_single_elem_test_selection_sort_iter_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    ENABLE_TEST(access_test_set(),populated_single_elem_test_selection_sort_iter_state_sorted);
}
