...
namespace sorting
{
    ...
    struct populated_double_inorder_test_selection_sort_index_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_double_revorder_test_selection_sort_index_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_double_noorder_test_selection_sort_index_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_multiple_same_elem_test_selection_sort_index_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_two_inorder_elem_test_selection_sort_index_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_two_revorder_elem_test_selection_sort_index_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
    ...
    struct populated_single_elem_test_selection_sort_index_state_sorted
	: public sorting_test_case
    {
	TEST_INSERTER;
    	void configure()
