...
{
    struct hashset_bucket_test_contains_compare_with_stdhashset : public hashset_bucket_test_case
    {
	test_result run()
	    {
    ...
    struct empty_contains_all_vals_return_empty : public hashset_bucket_test_case
    {
	TEST_INSERTER;
	test_result run()
	    {
    ...
    struct populated_inorder_contains_compare_with_stdhashset : public hashset_bucket_test_contains_compare_with_stdhashset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_inorder_all_contains_compare_with_stdhashset : public hashset_bucket_test_contains_compare_with_stdhashset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_noorder_contains_compare_with_stdhashset : public hashset_bucket_test_contains_compare_with_stdhashset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_noorder_all_contains_compare_with_stdhashset : public hashset_bucket_test_contains_compare_with_stdhashset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_revorder_contains_compare_with_stdhashset : public hashset_bucket_test_contains_compare_with_stdhashset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_revorder_all_contains_compare_with_stdhashset : public hashset_bucket_test_contains_compare_with_stdhashset
    {
	TEST_INSERTER;
	void configure()
	    {
