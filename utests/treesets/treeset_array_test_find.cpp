...
{
    struct treeset_array_test_find_compare_with_stdtreeset : public treeset_array_test_case
    {
	test_result run()
	    {
    ...
    struct empty_find_all_vals_return_end : public treeset_array_test_case
    {
	TEST_INSERTER;
	test_result run()
	    {
