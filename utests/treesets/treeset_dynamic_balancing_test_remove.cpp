...
{  
    struct treeset_dynamic_balancing_test_remove_compare_with_stdtreeset : public treeset_dynamic_balancing_test_case
    {
	test_result run()
	    {
    ...
    struct populated_inorder_remove_inorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_inorder_remove_revorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_inorder_remove_noorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_revorder_remove_inorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_revorder_remove_revorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_revorder_remove_noorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_noorder_remove_inorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_noorder_remove_revorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_noorder_remove_noorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_doubled_inorder_remove_inorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_doubled_shuffled_remove_inorder_compare_with_stdtreeset : public treeset_dynamic_balancing_test_remove_compare_with_stdtreeset
    {
	TEST_INSERTER;
	void configure()
	    {
