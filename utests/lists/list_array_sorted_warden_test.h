...
{
    using list_t = list_array_sorted_warden<T>;
    using index_t = typename list_t::index_t;
    static constexpr T min = list_t::min;
    static constexpr T max = list_t::max;
...
namespace test_list_array_sorted_warden
{
    ...
    struct list_array_sorted_warden_test_case
	: public test_case
    {
	using elem_t = int8_t;
	using TestPlug_t = TestPlug<list_array_sorted_warden<elem_t>>;
	using list_t = typename TestPlug_t::list_t;
	using index_t = typename TestPlug_t::index_t;
    public:
	static constexpr elem_t min = TestPlug_t::min;
	static constexpr elem_t max = TestPlug_t::max;
    ...
    inline list_array_sorted_warden_test_case::score_t operator +(list_array_sorted_warden_test_case::score_t left,
							   list_array_sorted_warden_test_case::score_t right)
