...
{
    using list_t = list_array_selforganizing<T>;
...
namespace test_list_array_selforganizing
{
    ...
    struct list_array_selforganizing_test_case
	: public test_case
    {

	using elem_t = int8_t;
	using TestPlug_t = TestPlug<list_array_selforganizing<elem_t>>;
    ...
    inline list_array_selforganizing_test_case::score_t operator +(list_array_selforganizing_test_case::score_t left,
								   list_array_selforganizing_test_case::score_t right)
