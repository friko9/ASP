...
{
    struct list_array_sorted_warden_test_populate_3elems_inorder : public list_array_sorted_warden_test_case
    {
    ...
    struct list_array_sorted_warden_test_populate_3elems_revorder : public list_array_sorted_warden_test_case
    {
	std::vector<elem_t> elems;
	std::vector<int> next,prev;
	void configure()
    ...
    struct populated_singleelem_exclude_elem_return_head_tail_only : public list_array_sorted_warden_test_case
    {
	TEST_INSERTER;
	void configure()
	    {
	...
	: public list_array_sorted_warden_test_populate_3elems_inorder
    {
	TEST_INSERTER;
	test_result run()
	    {
    ...
    struct populated_3elems_revorder_exclude_elem_first_return_2elems
    	: public list_array_sorted_warden_test_populate_3elems_revorder
    {
	TEST_INSERTER;
	test_result run()
	    {
    ...
    struct populated_3elems_noorder_exclude_elem_first_return_2elems
    	: public list_array_sorted_warden_test_populate_3elems_noorder
    {
	TEST_INSERTER;
	test_result run()
	    {
