...
{  
    struct list_array_enchanced_test_remove_compare_with_stdlist : public list_array_enchanced_test_case
    {
	test_result run()
	    {
	...
	: public list_array_enchanced_test_remove_compare_with_stdlist
    {
	TEST_INSERTER;
	void configure()
	    {
