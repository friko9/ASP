...
{
    struct list_array_sorted_test_populate_3elems_inorder_1_excluded : public list_array_sorted_test_case
    {
	int head,tail;
    ...
    struct list_array_sorted_test_populate_3elems_revorder_1_excluded : public list_array_sorted_test_case
    {
	int head,tail;
	std::vector<elem_t> elems;
	std::vector<int> next,prev;
    ...
    struct list_array_sorted_test_populate_3elems_noorder_1_excluded : public list_array_sorted_test_case
    {
	int head,tail;
	std::vector<elem_t> elems;
	std::vector<int> next,prev;
    ...
    struct populated_singleelem_move_elem_return_not_changed : public list_array_sorted_test_case
    {
	TEST_INSERTER;
	void configure()
	    {
	...
	: public list_array_sorted_test_populate_3elems_inorder_1_excluded
    {
	TEST_INSERTER;
	test_result run()
	    {
	...
	: public list_array_sorted_test_populate_3elems_revorder_1_excluded
    {
	TEST_INSERTER;
	test_result run()
	    {
	...
	: public list_array_sorted_test_populate_3elems_noorder_1_excluded
    {
	TEST_INSERTER;
	test_result run()
	    {
