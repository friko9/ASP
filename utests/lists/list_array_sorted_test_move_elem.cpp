...
{
    struct list_array_sorted_test_populate_3elems_revorder_1_excluded
    ...
    struct list_array_sorted_test_populate_3elems_noorder_1_excluded
	: public list_array_sorted_test_case
    {
	int head,tail;
	std::vector<elem_t> elems;
	...
	test_result run()
		...
		node_cmp_t head_cmp = test_node(head_ok, 0, {0,0,data[0]});
