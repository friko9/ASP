...
namespace test_list_stlforward
{
    ...
    struct list_stlforward_test_find_compare_with_stdlist : public list_stlforward_test_case
    {
	test_result run()
	    {
    ...
    struct empty_find_all_vals_return_end : public list_stlforward_test_case
    {
	TEST_INSERTER;
	test_result run()
	    {
    ...
    struct populated_inorder_find_compare_with_stdlist : public list_stlforward_test_find_compare_with_stdlist
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_noorder_find_compare_with_stdlist : public list_stlforward_test_find_compare_with_stdlist
    {
	TEST_INSERTER;
	void configure()
	    {
    ...
    struct populated_revorder_find_compare_with_stdlist : public list_stlforward_test_find_compare_with_stdlist
    {
	TEST_INSERTER;
	void configure()
	    {
