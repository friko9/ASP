...
{
    struct list_array_selforganizing_test_find_compare_with_stdlist : public list_array_selforganizing_test_case
    {
	test_result run()
	    {
    ...
    struct empty_find_all_vals_return_end : public list_array_selforganizing_test_case
    {
	TEST_INSERTER;
	test_result run()
	    {
	...
	: public list_array_selforganizing_test_find_compare_with_stdlist
    {
	TEST_INSERTER;
	void configure()
	    {
