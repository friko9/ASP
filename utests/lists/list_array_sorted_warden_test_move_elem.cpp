...
{
    struct list_array_sorted_warden_test_populate_3elems_inorder_1_excluded : public list_array_sorted_warden_test_case
    {
	std::vector<elem_t> elems;
	std::vector<int> next,prev;
	void configure()
	    {
		elems = { max, min, 1, 2, 3, 99 };
		next =  {null,   2, 3, 4, 0, 99 };
		prev =  {   4,null, 1, 2, 3, 99 };
    ...
    struct list_array_sorted_warden_test_populate_3elems_revorder_1_excluded : public list_array_sorted_warden_test_case
    {
	std::vector<elem_t> elems;
	std::vector<int> next,prev;
	void configure()
	    {
		elems = { max, min, 3, 2, 1, 99 };
		next =  {null,   4, 0, 2, 3, 99 };
		prev =  {   2,null, 3, 4, 1, 99 };
    ...
    struct list_array_sorted_warden_test_populate_3elems_noorder_1_excluded : public list_array_sorted_warden_test_case
    {
	std::vector<elem_t> elems;
	std::vector<int> next,prev;
	void configure()
	    {
		elems = { max, min, 2, 1, 3, 99 };
		next =  {null,   3, 4, 2, 0, 99 };
		prev =  {   4,null, 3, 1, 2, 99 };
    ...
    struct populated_singleelem_move_elem_return_not_changed : public list_array_sorted_warden_test_case
    {
	TEST_INSERTER;
	std::vector<elem_t> elems;
	std::vector<int> next,prev;
	...
	: public list_array_sorted_warden_test_populate_3elems_inorder_1_excluded
    {
	TEST_INSERTER;
	test_result run()
	    {
	...
	: public list_array_sorted_warden_test_populate_3elems_revorder_1_excluded
    {
	TEST_INSERTER;
	test_result run()
	    {
	...
	: public list_array_sorted_warden_test_populate_3elems_noorder_1_excluded
    {
	TEST_INSERTER;
	test_result run()
	    {
