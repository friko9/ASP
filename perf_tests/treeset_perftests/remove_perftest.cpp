...
make_subjects()
{
	...
	named_tester_pair(treeset_array_balancing,InsertPopulator,RemoveTester,T),
	    named_tester_pair(treeset_dynamic_balancing,InsertPopulator,RemoveTester,T),
	    named_tester_pair(treeset_stl,InsertPopulator,RemoveTester,T)
	    };
}
