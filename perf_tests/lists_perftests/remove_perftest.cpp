...
make_subjects()
{
	...
	named_tester_pair(list_array,InsertPopulator,RemoveTester,T),
	    named_tester_pair(list_array_enchanced,InsertPopulator,RemoveTester,T),
	    named_tester_pair(list_array_selforganizing,InsertPopulator,RemoveTester,T),
	    named_tester_pair(list_array_sorted,InsertPopulator,RemoveTester,T),
	    named_tester_pair(list_array_sorted_warden,InsertPopulator,RemoveTester,T),
	    named_tester_pair(list_dynamic,InsertPopulator,RemoveTester,T),
	    named_tester_pair(list_stl,InsertPopulator,RemoveTester,T),
	    named_tester_pair(list_stlforward,InsertPopulator,RemoveTester,T)
	    };
}
