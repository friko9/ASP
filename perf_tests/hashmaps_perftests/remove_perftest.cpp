...
make_subjects()
{
	...
	named_tester_pair(hbucket_echohash,InsertPopulator,RemoveTester,T),
	    named_tester_pair(harray_echohash_linRehash,InsertPopulator,RemoveTester,T),
	    named_tester_pair(harray_echohash_pow2Rehash,InsertPopulator,RemoveTester,T),
	    named_tester_pair(hashset_stl,InsertPopulator,RemoveTester,T),
	    };
}
