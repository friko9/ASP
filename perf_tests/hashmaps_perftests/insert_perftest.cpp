...
make_subjects()
{
	...
	named_tester_pair(hbucket_echohash,NullPopulator,InsertTester,T),
	    named_tester_pair(harray_echohash_linRehash,NullPopulator,InsertTester,T),
	    named_tester_pair(harray_echohash_pow2Rehash,NullPopulator,InsertTester,T),
	    named_tester_pair(hashset_stl,NullPopulator,InsertTester,T)
	    };
}
